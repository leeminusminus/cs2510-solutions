...
class Person implements IAT {
	...
	// (including this ancestor tree itself)
	public ILoString ancNames() {
		return new ConsLoString(this.name, new MtLoString()).append(this.mom.ancNames())
...
class ConsLoString implements ILoString {
	...
	//To compute a list of strings appended on another
	public ILoString append(ILoString that) {
		return this.appendHelp(new MtLoString()).appendHelp(that);
	}
...
class MtLoString implements ILoString {
	...
	public ILoString append(ILoString that) {
	 ...
	 //To compute an appended list via accumulation public ILoString
	 public ILoString appendHelp(ILoString that) {
		 return that;
	 }
}
...
class ExamplesIAT {
	...
	ILoString string2 = new ConsLoString("Orange",
			new ConsLoString("Pear", new ConsLoString("Lemon", this.mt)));
	...
	boolean testYoungerIAT(Tester t) {
		return t.checkExpect(this.unk.youngerIAT(this.unk), this.unk)
