...
class Publisher{
	...
	Publisher(String name, String country, int opened){
		this.name = name;
...
// publishers
class ExamplesPublishers{
	ExamplesPublishers(){}
	
	Publisher pearson = new Publisher("Pearson", "United Kingdom", 1998);
	Publisher nostarch = new Publisher("No Starch Press", "United States", 1994);
}
...
class ExamplesBooks{
  ...
  Book beaches = new Book("Beaches", this.pat, this.doubleday, 20);
